    ...
    <footer class="blog-footer align-content-center"> 
    <p>
        <a href="{{ url()->previous() }}">Back to top</a>
        
    </p>
      <p align="center">Pagina Web de Parroquia Basilica del Corazón de maría <a href="www.sanjudas.cl">San judas Tadeo</a> by <a href="https://twitter.com/sanjudas  ">@sanjudas</a>.</p>
